...
# Modified: Victor Martinez 11/06/2018
...
def base_model_config(dataset='PASCAL_VOC'):
  assert dataset.upper()=='PASCAL_VOC' or dataset.upper()=='KITTI' or dataset.upper()=='ROE', \
      'Currently only support PASCAL_VOC, KITTI or ROE dataset'
  ...
  elif cfg.DATASET == 'ROE':
    cfg.CLASS_NAMES = ('door', 'lightswitch', 'extinguisher', 'exitsign')
